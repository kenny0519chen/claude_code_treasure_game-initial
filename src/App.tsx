...
export default function App() {
  ...
  const openBox = (boxId: number) => {
    ...
    const sound = box?.hasTreasure === false ? evilLaughSound : chestOpenSound;
      ...
      {gameEnded && (
            ...
            >
              <div className="mb-4 p-6 bg-amber-200/80 backdrop-blur-sm rounded-xl shadow-lg border-2 border-amber-400">
                ...
                <div className={`text-4xl font-bold mb-3 ${score > 0 ? 'text-green-600' : score === 0 ? 'text-amber-500' : 'text-red-600'}`}>
